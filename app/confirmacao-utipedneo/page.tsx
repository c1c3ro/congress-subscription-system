...
const LOGO_URL = "/logo-uti-pedneo.webp";
const COLOR_THEME = "pink";

// Horários fictícios para os slots
const HORARIOS = [
  { slot: 0, dia: "Dia 25/04", horario: "08:00 - 12:00" },
  { slot: 1, dia: "Dia 25/04", horario: "14:00 - 18:00" },
  { slot: 2, dia: "Dia 26/04", horario: "08:00 - 12:00" },
];
...
export default function ConfirmacaoPage() {
  ...
  return (
    <main className="min-h-screen bg-linear-to-b from-pink-50 to-white flex items-center justify-center p-4">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full bg-[#E11D48] hover:bg-[#C2102D] text-white"
                >
                          ...
                          <button
                            ...
                            className={`
                              ...
                              ${esgotado 
                                ...
                                : selecionado
                                  ? "bg-[#E11D48]/10 border-[#E11D48]"
                                  : !podeAdicionar && selectedWorkshops.size > 0
                                    ? "bg-gray-50 border-gray-200 cursor-not-allowed opacity-60"
                                    : "bg-white border-gray-200 hover:border-[#E11D48]/50"
                              }
                            `}
                          >
